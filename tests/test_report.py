...
class TestReport(unittest.TestCase):
    ...
    def test_html_embeds_plot_download_links(self) -> None:
        ...
        self.assertIn('<h4 id="saturn">Saturn <span class="ency">', sky_page)
        self.assertIn('<h4 id="vega">Vega <span class="ency">', sky_page)
    ...
    def test_html_embeds_iau_constellation_gallery(self) -> None:
        ...
        self.assertIn("<summary>Andromeda <span class=\"ency\">", iau)
