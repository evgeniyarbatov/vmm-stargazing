...
help:
	...
	@echo "gpx GPX=…   - copy/densify GPX + bbox → \$$(DATA_DIR)/"
	...
	@echo "run GPX=…   - gpx → dem → timeline → sky → report"
	...
	@echo "Example: make run GPX=~/Downloads/vietnam-mountain-marathon-2024-ultra-100-miles.gpx"
